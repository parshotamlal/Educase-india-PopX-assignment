    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4">
      ...
      <div className="w-[375px] min-h-[700px] bg-white rounded-2xl shadow-2xl p-6 flex flex-col">
        ...
        <div className="bg-gray-50 rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          <div className="flex items-start space-x-4">
            ...
            <div className="relative">
              <img
                src={
                  user?.avatar ||
                  "https://thumbs.dreamstime.com/z/woman-talking-mobile-phone-home-close-up-portrait-happy-50985478.jpg?ct=jpeg"
                }
          ...
          {/* Description */}
          <div className="bg-gray-50 rounded-2xl shadow-sm border border-gray-100 p-6 mt-4">
            <p className="text-gray-600 text-sm leading-relaxed">
               {user?.fullName || "Guest"}, This is your profile page.
            </p>
          </div>
        </div>
      </div>
